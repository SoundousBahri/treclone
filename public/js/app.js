...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    changeOrder: function changeOrder(data) {
      if (data.newIndex !== data.oldIndex || data.to.dataset.id !== data.from.dataset.id) {
        axios.patch("api/task/".concat(data.item.dataset.id), {
          order: data.newIndex,
          category_id: data.to.dataset.id
        }).then(function (response) {});
      }
    },
    endEditing: function endEditing(task, categoryIndex, taskIndex) {
      var _this2 = this;
      ...
      if (task.name.trim()) {
        if (task.id !== undefined) {
          ...
          axios.post('api/task', task).then(function (response) {
            _this2.categories[categoryIndex].tasks[taskIndex] = response.data.data;
          });
        }
      } else {//this.categories[categoryIndex].tasks[taskIndex]=null;
      }
    },
  ...
  computed: {
    ...
    dragOptions2: function dragOptions2() {
      return {
        group: 'cards',
        handle: '.card-header'
      };
      ...
      [
        _c(
          "draggable",
          {
            ...
            attrs: { element: "div", options: _vm.dragOptions2 },
            model: {
          ...
          [
            _c(
              "transition-group",
              { staticClass: "row" },
              _vm._l(_vm.categories, function(element, i) {
                  ...
                  _c("div", { staticClass: "card" }, [
                    ...
                    _c(
                      ...
                      [
                            ...
                            _c(
                              ...
                              _vm._l(element.tasks, function(task, index) {
                                return _c(
                                  ...
                                  [
                                    task.name.trim() || task === _vm.editingTask
                                      ? _c(
                                          "div",
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "small-card btn w-100" }, [
                          _c(
                            "h5",
                            {
...
__webpack_require__(/*! D:\Documents\Laravel Projects\laravel-vue-course\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Documents\Laravel Projects\laravel-vue-course\resources\sass\app.scss */"./resources/sass/app.scss");
